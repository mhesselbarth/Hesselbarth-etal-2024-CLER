...
Landscape connectivity describes how landscape features facilitate or impede movement, flow, and dispersal of organisms, e.g., direct movement of animals, but dispersal of sessile plants by wind or water, and can be divided into structural and functional connectivity [@Taylor2006LandscapeConnectivity].
...
Generally, movement and dispersal data from individuals is required to infer the elements in the landscape that individuals preferentially move or disperse through [@Simpkins2018AssessingPerformance].
...
The edges can be binary representing whether a connection between two nodes either exists or does not exists, weighted by cost values representing movement efforts from one patch to another, or undirected or directed allowing movement and dispersal in both or only one direction [@Urban2001LandscapeConnectivity; @Petsas2021LandscapeConnectivity].
