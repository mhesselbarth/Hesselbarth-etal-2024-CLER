...
To address some limitations, such as correlation and consistency, multivariate factor analysis [@Riitters1995], principal component analysis [@Cushman2008Parsimony], the variance inflation factor [@Plexida2014], or classification trees [@Breiman2017] were used to identify main components of landscape patterns.
...
This is in line with various reviews [e.g., @Gustafson2019HowHas; @Riitters2019PatternMetrics] suggesting that there are two fundamental components of landscape patterns, namely amount and adjacency, which are connected to complexity and aggregation as suggested by @Nowosad2018.
