...
Genetic data can be applied to complement ecological data to integrate evolutionary processes and patterns into landscape ecology [@Holderegger2008LandscapeGenetics; @Manel2003LandscapeGenetics; @Balkenhol2017LandscapeGenomics].
...
Landscape genetic approaches have been used traditionally to inform landscape ecology applications, e.g., through connectivity modelling and spatial conservation planning [@Manel2003LandscapeGenetics; @Holderegger2008LandscapeGenetics; @Manel2013TenYears; @Bolliger2014LandscapeGenetics].
Using holistic approaches that consider evolutionary processes and patterns in addition to ecological data can fortify results, e.g., improving predictive models of species range shifts in response to climate change [e.g., @Aguirre-Liguori2021EvolutionaryGenomics], improving the identification and delineation of landscape connections among populations [e.g., @Homola2019LandscapeGenetics; @deFlamingh2024IntegratingHabitat], allowing for the interpretation of spatial structuring in context of socio-cultural connections [e.g., @Henson2021ConvergentGeographic], or understanding local adaptation associated with specific environments [@Sork2013PuttingLandscape; @Rolland2015CombiningNiche; @Aguirre-Liguori2021EvolutionaryGenomics].
...
Additionally, popular software for landscape genetics includes the R packages *graph4lg* [@Savary2021Graph4lgPackage], or *landgenreport* [@Gruber2015LandgenreportNew], besides others.
Furthermore, series of Python scripts have been developed for use in landscape genetics studies [@Etherington2011PythonBased], or GIS-based toolboxes written in Python exist that provide landscape genetics functionality [e.g., Brown2017SDMtoolbox20].
