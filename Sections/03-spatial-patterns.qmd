...
Additionally, it is possible to calculate spatial signatures for multiple areas and group them into similar clusters based on their signatures [@Nowosad2021PatternbasedIdentification].
