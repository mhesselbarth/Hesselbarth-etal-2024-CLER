...
Typical research topics include, besides others, pattern-process links, landscape complexity, ecological flows, scale effects, landscape modelling, conservation, drivers and consequences of land use and land cover (LULC) change, including human activities [@Wu2013KeyConcepts].
...
Computational ecology is crucial for the research field because data is often context- and scale-dependent, making it challenging to design controllable, reproducible, and replicable experiments [@Petrovskii2012ComputationalEcology; but see @Wiersma2022ReviewLandscape]. <!--JN: why do you use "but see" here? is the Wiersma2022 paper contradicting Petrovskii2012?-->
...
![Overview of landscape ecology topics for which computational developments are discussed.](Figures/Fig-1.png){width=80%}