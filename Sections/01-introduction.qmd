...
Here, we introduce recent computational developments in multiple key topics of landscape ecology (Fig. 1), including software that implements or is potentially capable of executing them (Tab. 1).
...
![Overview of landscape ecology topics for which computational methods are discussed. The image uses modified Copernicus Sentinel-2 data from 2024-09-07.](Figures/Fig-1.jpg)
