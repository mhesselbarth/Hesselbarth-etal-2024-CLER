...
<!-- JN: the first and the second point seem to be mixed in the text atm-->
Here, we first introduce recent computational developments in the most important topics of landscape ecology.
<!-- This includes, for example, spatial patterns quantification, connectivity and movement, or model simulations. -->
Second, we present common software tools that implement or are potentially capable of implementing them.
Lastly, we discuss potential future directions for the development of computational methods in landscape ecology.

<!--JN: I am not the biggest fan of the following definition of open science: full transparency is rarely a goal IMO.-->
