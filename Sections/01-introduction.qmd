...
Here, we introduce recent computational developments in multiple key topics of landscape ecology (Fig. 1), including software that implements or is potentially capable of implementing them (Tab. 1).
