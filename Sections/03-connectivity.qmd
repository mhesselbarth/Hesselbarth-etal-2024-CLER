...
Thus, in the past multiple approaches how to computationally measure connectivity were developed [@Simpkins2018AssessingPerformance; @Keeley2021ConnectivityMetrics].

<!-- 
Connectivity modelling in conservation science https://doi.org/10.1038/s41598-022-20370-w
-->

## Landscape metrics related to connectivity
...
This concept uses environmental layers and biodiversity data or expert opinions to estimate the cost and of movement through landscapes [@Zeller2012EstimatingLandscape].
The latest developments of resistance surfaces have recently been reviewed by @Dutta2022OverviewComputational.
...
<!--maybe add "Julia's", "R's", "Python's" before the software names?-->
Software to model connectivity based on resistance surfaces include *ConScape.jl* [@vanMoorter2023AcceleratingAdvances], *Omniscape.jl* [@Landau2021OmniscapejlSoftware], *lconnect* [@Mestre2023LconnectPackage], *grainscape* [@Chubaty2020ToolboxGrainscape], or *Circuitscape* [@Anantharaman2019CircuitscapeJulia].
