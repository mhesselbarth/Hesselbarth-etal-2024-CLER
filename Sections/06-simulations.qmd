...
They can also incorporate a range of socio-economic, political and governance information to influence how agents (such as farmers) interact within a landscape [@murray2014combining].
...
Digital twins are increasingly applied in agricultural landscapes research, e.g., for livestock farming, controlled environment farming, or fertilization management [@Cesco2023SmartAgriculture; @Purcell2023DigitalTwins]. Further applications include planning of rural ecological landscapes [@Tan2024DigitalTwin] or exploration of relationships between urban expansion and vegetation coverage [@Zhao2022ApplyingDigital].
