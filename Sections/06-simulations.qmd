...
Landscape simulators are typically used to generate null hypotheses, baselines, or scenarios that allow to control certain aspects of the landscape [@Li2004EvaluatingEffectiveness; @Wang2008NeutralLandscapes] and are generally simpler than ecological simulation models [@Hess2020PioLaGPiosphere].
...
The digital twins concept include three connected elements, namely *i)* a physical object or system, *ii)* its digital representation, *iii)* and a data exchange between the former two [@Jones2020CharacterisingDigital; @deKoning2023DigitalTwins] and there is increasing interest and use of digital twins in both the industry and academia [@Jones2020CharacterisingDigital].
