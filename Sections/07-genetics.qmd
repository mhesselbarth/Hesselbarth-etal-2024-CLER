...
Using holistic approaches that consider evolutionary processes and patterns in addition to ecological data can fortify results, e.g., by improving predictive models of species range shifts in response to climate change [@Aguirre-Liguori2021EvolutionaryGenomics], improving the identification and delineation of landscape connections among populations [@Homola2019LandscapeGenetics; @deFlamingh2024IntegratingHabitat], allowing for the interpretation of spatial structuring in context of socio-cultural connections [@Henson2021ConvergentGeographic], or understanding local adaptation associated with specific environments [@Sork2013PuttingLandscape; @Rolland2015CombiningNiche; @Aguirre-Liguori2021EvolutionaryGenomics].

Advances in molecular methodologies and synergistic developments of bioinformatic and computational approaches to analyze large-scale genomic data have recently enabled the integration of genome-wide data with spatial ecological data.
