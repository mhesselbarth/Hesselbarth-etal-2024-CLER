...
<!-- In order to make multiple neutral landscape model algorithms accessible, several software libraries are available in prominent programming languages including Python [NLMpy\; @Etherington2015], R [ c], Julia (https://github.com/EcoJulia/NeutralLandscapes.jl), or GUI software (GradientLand, QRULE) -->
