...
Thus, simulations can be seen as experimental systems that allow all imaginable manipulations in order to advance theoretical developments or test hypotheses, which would be impossible in natural systems [@Peck2004SimulationExperiment].
...
Landscape simulators are typically used to generate null hypotheses, baselines, or scenarios that allow the users to control certain aspects of the landscape [@Li2004EvaluatingEffectiveness; @Wang2008NeutralLandscapes], and are generally simpler than ecological simulation models [@Hess2020PioLaGPiosphere].
...
Thus, digital twins aim to provide real-time state of nature measurements, early detection of conservation trends, relationships of ecosystem trends and environmental conditions, impact assessments of interventions, or to identify uncertainties and information gaps [@deKoning2023DigitalTwins].
