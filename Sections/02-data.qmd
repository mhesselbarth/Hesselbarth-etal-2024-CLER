...
Raster data uses regularly spaced grid cells, while vector data uses points, lines, and polygons to represent landscape features [@With2019EssentialsLandscape].
...
Data quality is generally variable, and data products are not flawless and can contain errors and biases.
...
Furthermore, these misclassification is not random, but are often correlated with specific LULC types, regions, and seasonal variations [@Liu2021FinerresolutionMapping].
