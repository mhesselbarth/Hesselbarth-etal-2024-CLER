...
\noindent Keywords: (1) spatial data, (2) spatial patterns, (3) pattern-process link (4) open-source, (5) scientific software
...
<!-- JN: Max, should this be uncommented? -->
...
<!-- JN: Are we proactively thankful? I would suggest to uncomment this sentence and reinstate it when the final version of the paper is accepted -->
